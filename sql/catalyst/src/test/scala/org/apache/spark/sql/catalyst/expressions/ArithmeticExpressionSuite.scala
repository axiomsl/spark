...
class ArithmeticExpressionSuite extends SparkFunSuite with ExpressionEvalHelper {
  ...
  test("function LeastNullIntolerant") {
    ...
    val c4 = 'a.string.at(3)
    val c5 = 'a.string.at(4)
    checkEvaluation(LeastNullIntolerant(Seq(Literal.create(null, IntegerType), Literal(2))), null, row)
...
//    checkEvaluation(least, Seq(1, 2))
  ...
  test("function GreatestNullIntolerant") {
    ...
    val c4 = 'a.string.at(3)
    val c5 = 'a.string.at(4)
    checkEvaluation(GreatestNullIntolerant(Seq(Literal.create(null, IntegerType), Literal(2))), null, row)

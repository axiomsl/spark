...
object JsonConstants {
  ...
  val appInfoJsonStr =
    ...
    """.format(System.getProperty("user.name", "<unknown>"),
        submitDate.toString, currTimeInMillis - appInfoStartTime)
  ...
  val masterStateJsonStr =
    ...
    """.format(workerInfoJsonStr, workerInfoJsonStr,
        appInfoJsonStr, driverInfoJsonStr, driverInfoJsonStr)
  ...
  val workerStateJsonStr =
    ...
    """.format(executorRunnerJsonStr, executorRunnerJsonStr)
}
